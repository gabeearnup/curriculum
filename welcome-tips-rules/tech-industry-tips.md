...
- Don't leave your email open all the time. Disable email notifications on mobile and laptop and don't become interrupt-driven. 
- The same goes for Slack. Use the Snooze feature liberally and keep it minimized so interesting GIFs don't tempt you when you're trying to read or code.
...
- Make sure your email is set to reply all by default so you don't leave people out (except for when you're responding to a mailing list message and not everyone will want or need your reply).
...
- Learn as many keyboard shortcuts as you can so mentors don't get impatient while watching you move back and forth between the keyboard and mouse or trackpad.
...
- Let the organizers know if you can't make it to an event for which you signed up.
